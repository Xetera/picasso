// https://github.com/fingerprintjs/fingerprintjs/blob/7096a5589af495f1f46067963e13ad27d887d185/src/utils/hashing.ts
...
export function hashCanvasData(data: string, seed: number): string {
  return x64hash128(data, seed)
}